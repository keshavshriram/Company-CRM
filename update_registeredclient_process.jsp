...
<script type="text/javascript">
	function validation()
	{
		...
		{
			alert("Please enter the Client Information");
			document.f1.client_info.focus();
			return false;
		}
		
		if(document.f1.comp_name.value=="")
		{
			alert("Please enter the Company Name");
			document.f1.comp_name.focus();
			return false;
		}
		
		if(document.f1.comp_add.value=="")
		{
			alert("Please enter the Company Adsress");
			document.f1.comp_add.focus();
			return false;
		}
...
<body onload="showDate()">
   ...
   <div class="form formdiv">
       <form name="f1" method="POST" action="update_registeredclient.jsp">
   	 	<h3 class="text-center">Update Client</h3>
                <div class="form-group">
   	 		
                    <input type="hidden" name="reg_id" readonly class="form-control" value="<%=rs.getInt("REG_ID")%>">
   	 	</div>
   	 	<div class="form-group">
   	 		Registration Date
                        <input type="text" name="enq_date" readonly class="form-control" value="<%=rs.getString("REG_DATE")%>">
   	 	</div>
   	 	...
   	 	<div class="form-group">
                    Company Name
                    <input type="text" name="comp_name" class="form-control" value="<%=rs.getString("COMP_NAME")%>">
   	 	</div>

   	 	<div class="form-group">
                    Company Address
                    <input type="text" name="comp_add" class="form-control" value="<%=rs.getString("COMP_ADD")%>">
   	 	</div>

   	 	<div class="form-group text-center">
   	 		<button class="btn btn-info">Go To dashboard</button>

   	 		<button class="btn btn-info" type="submit" onclick="return validation()">Update Client</button>
